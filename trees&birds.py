...
def draw_bird(x, y):
    ...
    arcade.draw_circle_filled(x + 40, y, 20, arcade.color.WHITE)

    arcade.draw_arc_outline(x, y, 20, 40, arcade.color.BLACK, 0, 90)
    arcade.draw_arc_outline(x + 40, y, 20, 20, arcade.color.BLACK, 90, 180)

    arcade.draw_point(x + 40, y, arcade.color.RED, 5)
...
def draw_pine_tree(x, y):
    ...
    arcade.draw_point(x + 40, y, arcade.color.WHITE, 5)
    arcade.draw_point(x, y - 100, arcade.color.RED, 5)
    arcade.draw_point(x + 80, y - 100, arcade.color.BLUE, 5)
...
#    draw_pine_tree(250, 270)
#    draw_pine_tree(150, 450)
    draw_bird(70, 500)
    draw_bird(470, 550)
